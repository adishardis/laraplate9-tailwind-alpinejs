...
if (!function_exists('checkMethod')) {
     ...
     * @param boolean $showAbort
     * @param array $headers
     */
    function checkMethod($action = 'create', $request, $showAbort = false, $headers = [])
    {
        $availableMethods = [
            'create' => ['POST'],
            'update' => ['PUT', 'PATCH'],
...
if (!function_exists('checkApiMethod')) {
     ...
     * @param boolean $showAbort
     */
    function checkApiMethod($action = 'create', $request, $showAbort = false)
    {
