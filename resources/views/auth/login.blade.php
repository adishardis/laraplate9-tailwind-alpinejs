<x-auth-layout>
    ...
    <div class="absolute top-0 w-full h-full bg-slate-800 bg-full bg-no-repeat"
        style="background-image: url({{ url('notus-js/img/register_bg_2.png') }})">
    </div>
                        ...
                        <div class="btn-wrapper text-center">
                            <a href="{{ url('login/github') }}"
                                ...
                                <img alt="{{ __('Sign in with Github') }}" class="w-5 mr-1"
                                    src="{{ url('/notus-js/img/github.svg') }}" />
                                Github
                            </a>
                            <a href="{{ url('login/google') }}"
                                ...
                                <img alt="{{ __('Sign in with Google') }}" class="w-5 mr-1"
                                    src="{{ url('notus-js/img/google.svg') }}" />
                                Google
                            </a>
                            <a href="{{ url('login/facebook') }}"
                                ...
                                <img alt="{{ __('Sign in with Facebook') }}" class="w-5 mr-1"
                                    src="{{ url('/notus-js/img/icons8-facebook.svg') }}" />
                                Facebook
                            </a>
                        </div>
                        {{-- Error --}}
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="flex flex-wrap mb-10">
                                <div class="w-1/2">
                                    <a href="{{ route('password.request') }}" class="text-slate-700">
                                        <small>{{ __('Forgot your password?') }}</small>
                                    </a>
                                </div>
                                <div class="w-1/2 text-right">
                                    <a href="{{ route('register') }}" class="text-slate-700">
