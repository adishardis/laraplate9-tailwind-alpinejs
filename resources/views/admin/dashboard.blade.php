<x-admin-base-layout>
  {{-- Page Title --}}
  <x-page-title :title="'Dashboard'" :role="'Admin'" />
  {{-- End Page Title --}}

  {{-- Nav Header --}}
  <x-slot name="navHeader">
    <x-navbar-header :url="`{{ route('admin.dashboard') }}`" :text="'Dashboard'" />
  </x-slot>
  {{-- End Nav Header --}}
  ...
  <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
      ...
      <div class="block w-full overflow-x-auto">
        <!-- Posts summary table -->
        <div x-data="{
          url: '/admin/fetch/dashboard?mode=summary',
          posts: [],
          summaries: [],
  ...
  <div class="w-full xl:w-4/12 px-4">
    <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
      ...
      <div class="block w-full overflow-x-auto">
        <!-- Summary profile -->
        <div x-data="{
          url: '/admin/fetch/profile?mode=summary',
          totalLikes: 0,
          totalDislikes: 0,
          totalComments: 0,
